	...
	<div class="wrapper sidebar_minimize">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="dark2">
				...
				<a href="db_orders2.php" class="logo">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item active submenu">
							...
							<div class="collapse show" id="tables">
								<ul class="nav nav-collapse">
									<li class="active">
										<a href="../demo2/tables/db_orders2.html">
											<span class="sub-item">Orders</span>
										</a>
									</li>
									<li >
										<a href="../tables/db_shipping2.html">
		...
		?>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Modicication Form</div>
								</div>
								<div class="card-body">
									<div class="row">
									...
									<div class="form-group">
										...
										<label for="ref_cmd">cmd ref:
												...
												<input type="number" class="form-control" id="ref_cmd" value="<?php echo $orders['ref_cmd']; ?>" >
												<small  class="form-text text-muted">We'll never share your email with anyone else.</small>
											</div>
											<div class="form-group">
											<label for="Date_conf">date conf:
                        </label>
												<input  onblur="saisirDate_conf()" type="date" class="form-control"  type="date" name="Date_conf" id="Date_conf" value="<?php echo $orders['Date_conf']; ?>" >
                    <p id="errorCD" class="error"></p>
						...
						<input onblur="saisirpay()" type="text" name="mode_paiement" id="mode_paiement" class="form-control" value="<?php echo $orders['mode_paiement']; ?>"  >
						...
						<input onblur="saisirState()" type="text" name="etat" id="etat" class="form-control" value="<?php echo $orders['etat']; ?>" >
						...
						<input onblur="saisirDate_realisation()" type="date"class="form-control" name="Date_realisation" id="Date_realisation"  value="<?php echo $orders['Date_realisation']; ?>">
                        <p id="errorPD" class="error"></p>
								...
								<div class="card-action">
									<button class="btn btn-success" type="submit" name="Modifier" value="Modifier" onclick="ajout(event)">Submit</button>
