...
?></span>
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">+216 23 445 223</span>
					    </div>
				    </div>
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="courses.php" class="nav-link">Couses</a></li>
	        	<li class="nav-item"><a href="produitf.php" class="nav-link">Shop</a></li>
	        	<li class="nav-item"><a href="pricing.html" class="nav-link">Quiz</a></li>
		          ...
		          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18">
		              ...
		              <div class="text">
		                ...
		                <span>Training events organised this year</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
