...
$filesC = new servic();
	...
	$produit = $produitC->recupererref($id);
   
    if (isset($id)){
        $files = $filesC->trouverProd($id);
							...
							<ul>
								...
								<li><a href="#">Pages</a>
									<ul class="sub-menu">
										...
										<li><a href="order_details.php">Check Out</a></li>
			...
			<div class="container">
				<div class="row d-flex align-items-stretch no-gutters">
					<div class="col-md-6 p-4 p-md-5 order-md-last bg-light" id="pdf">
						  ...
						  <input  name="id_prod" id="id_prod" type="number" class="form-control" placeholder="fill with today's date" value="<?php echo $id ?>" readonly>
						 <label> Your ID</label>
						  <input  name="id_client" id="id_client" type="number" class="form-control" placeholder="fill with today's date" value="<?php echo $_SESSION['e'];?>" readonly>
						...
						<div class="form-group">
						  ...
						  <div class="form-group">
						  <label>Price</label>
						        		<p><input name="montant_cmd" id="montant_cmd" type="number" class="form-control" placeholder="fill with the global price of the order" value="<?php echo $produit['prix'] ?>" readonly></p>
										...
										<label>Payment method</label>
																	...
																	<select  onblur="saisirProduct()" name="product" id="product"  class="form-control" p >
																		...
																		<label>Quantity</label>
																			<input type="number" name="qtt_prod" id="qtt_prod" class="form-control"><br>			
