...
$order_cl=$ordersC->recupererorders($ref);
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						...
						<h1>Your order has been validated</h1>
					</div>
				</div>
			</div>
		</div>
    ...
    <div class="card px-2">
        <div class="card-header bg-white">
            <div class="row justify-content-between">
                <div class="col">
                    <p class="text-muted"> Order ID <span class="font-weight-bold text-dark"><p><?php echo $order_cl['ref_cmd']; ?></p></span></p>
                    <p class="text-muted"> Placed On <span class="font-weight-bold text-dark"><p><?php echo $order_cl['Date_conf']; ?></p></span> </p>
					<p class="text-muted"> State <span class="font-weight-bold text-dark"><p><?php echo $order_cl['etat']; ?></p></span></p>
					<p class="text-muted"> Payment method <span class="font-weight-bold text-dark"><p><?php echo $order_cl['mode_paiement']; ?></p></span></p>
				</div>
