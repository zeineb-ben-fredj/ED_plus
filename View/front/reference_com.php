						    ...
						    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
						      <div class="card-body">
						        <div class="billing-address-form">
						        	<form action="shipping_page.php" method="POST">
						        		<p><input type="number" placeholder="Order's reference" name="ref_cmd" id="ref_cmd"></p><br>
						        		<button type="submit"   name="Save" class="btn btn-success"  >Track your order</button>
						        	</form>
						        </div>
						      </div>
						    </div>
