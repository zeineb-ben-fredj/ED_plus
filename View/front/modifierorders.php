...
<head>
 ...
 body {
  ...
  background-color: #fff;
    ...
    <body>
        <button><a href="order_details.php">Return to your order details</a></button>
        <hr>
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <input  type="hidden" name="etat" id="etat" value= "<?php echo $orders['Date_conf']; ?>"  >
                ...
                <input  type="hidden" name="etat" id="etat" value="<?php echo $orders['etat']; ?>"   >
                <!-- <tr>
                    <td>
                        <label for="etat">etat:
                        </label>
                    ...
                    <td>
                    <select  name="etat" id="etat"  class="form-control" type="hidden" >
