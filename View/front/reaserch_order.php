...
<head>
	...
	<!-- title -->
	<title>Check Out your order's details</title>
...
<body>
	...
	<center><p><label>Your order's reference:</label></p></center><br>
						        		<center><p><input class="form-control" type="number" placeholder="Order's reference" name="ref_cmd" id="ref_cmd" ></p></center><br>
						        		<center><button type="submit" name="Save" class="btn btn-outline-success"  >check out your order's details</button></center>
						        	</form>
									</div>
	...
	<!-- <center><a href="checkout_card.html" class="boxed-btn black" > <h4 style="color: aliceblue;">Card Payment</h4></a></center> <br>
	<center><a href="checkout_shipping.html" class="boxed-btn black"> <h4 style="color: aliceblue;">Shipping Payment</h4></a></center> -->
	<br>
	<br>
	<br>
	<!-- check out section -->
