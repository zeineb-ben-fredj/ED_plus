							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Categories database</h4>
...
<center><a href="ajouterrs.php"> <button type="button" class="btn btn-primary btn-round ml-auto" ><i class="fa fa-plus"></i>Add Category</button></a></center>
<br>
  <br>
...
<button type="submit" value="Modifier" name="Modifier" class="btn btn-outline-info"  style="margin-top:3%;margin-left:5%;border-radius: 10%;">Edit</button>
<input type="hidden" value="<?php echo $pro['id'] ?>" name="id">
</form></td>
</tr>
<?php
