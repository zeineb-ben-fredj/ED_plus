...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
		...
		<div class="main-panel">
					 ...
					 <div class="d-flex align-items-center">
						...
						<div class="col-md-12">
							<div class="card">
								...
								<form action = "tri_files.php" method = "get" >
									
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Sort Files</h4>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<p class="small">Add a new file using this form, make sure you fill them all</p>
													<form action=""  method="POST">
														<div class="row"> 
                                                       	
															<!-- <div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>idfichier</label>
																	<input  id="idfichier" name="idfichier" type="number" class="form-control" placeholder="fill ID">
															...
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>Name</label>
																	<input  id="nomfichier" name="nomfichier" type="string" class="form-control" placeholder="fill name">
															...
															<div class="col-md-6 pr-0">
																<div class="form-group form-group-default">
																<label>Type</label>
																	<select onchange="saisirtype()" name="typefichier" id="typefichier">
															...
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	...
																	<input onchange="saisirdateof_publication()" id="dateof_publication" type="date" name="dateof_publication" class="form-control" placeholder="fill date">
																	<p id="errordatepub" class="error"></p>
																</div>
															</div>
                                                            <div class="col-md-6 pr-0">
																<div class="form-group form-group-default">
																<label>lesson_level</label>
																	<select onchange="saisirlevel()" name="lesson_level" id="lesson_level">
                                                                    <option value="select">Select</option>
                                                                    <option value="Beginner">Beginner</option>
                                                                   <option value="Intermediate ">Intermediate</option>
                                                                   <option value="Advanced ">Advanced</option>
                                                                 </select><br>
                                                                  <p id="errorlevel" class="error"></p>
															...
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	...
																	<input id="descriptionfichier" name="descriptionfichier" type="string" class="form-control" placeholder="fill description">
                                                               </div>
															</div>
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>Upload File</label>
																	<input id="uploadfichier" name="uploadfichier" type="file" class="form-control" >
                                                               </div>
															</div>
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>Picture</label>
																	<input id="filepic" name="filepic" type="file" class="form-control" >
                                                               </div>
															</div>
															 <!-- <div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>ID_Course</label>
																	<input onblur="saisirID()" id="ID_Course" name="ID_Course" type="number" class="form-control" placeholder="fill ID course">
															...
															<div class="col-md-6 pr-0">
																...
																<label>Course ID</label>
																	<select onblur="saisirid()" name="id_cc" id="id_cc" required>
                                                                    <option value="select">Select</option>
			...
			<tr>
				...
				<td>
					<a class="btn btn-outline-secondary" href="supprimerfiles.php?idfichier=<?php echo $files['idfichier']; ?>">Delete</a>
				</td>
			</tr>
			<?php
				}
