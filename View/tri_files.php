...
if (isset($_GET["sort"]) AND $_GET["sort"] == "sort"){
...
try {
  $conn = new PDO('mysql:host=localhost;dbname=order_managment' , 'root', "");
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
  $stmt = $conn->prepare("SELECT idfichier, nomfichier , typefichier, dateof_publication, lesson_level, descriptionfichier, uploadfichier, filepic, id_cc  FROM tabfiles ORDER BY nomfichier");
  $stmt->execute();
