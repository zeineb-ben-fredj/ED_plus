...
if(isset($_GET['sort']) && isset($_GET['pp']) && !empty($_GET['pp']) && ctype_digit($_GET['pp'])==1 && isset($_GET['p']) && !empty($_GET['p']) && ctype_digit($_GET['p'])==1){
	if($_GET['sort']=="ASC")
	{$listeorders=$ordersC->afficherordersASC($perPage,$firstOfPage); }
else if($_GET['sort']=="DESC")
{$listeorders=$ordersC->afficherordersDESC($perPage,$firstOfPage); }
...
<input type="hidden" name="p" value="<?php echo $current ?>">  <br>
