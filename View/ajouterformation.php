...
var formation=document.getElementById("nom").value;
var regex = /^[A-Za-z]+$/;
...
if (!(regex.test(formation))) {
	...
	return 0;
} else if (formation[0] == formation[0].toLowerCase()) {
	document.getElementById("errorC").textContent = "Name has to start by a capital letter!";
	document.getElementById("errorC").style.color = "red";
	return 0;
} else {
	document.getElementById("errorC").textContent = "formation Verified";
									...
									<div class="row">
										<div class="col-md-8 col-lg-5">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" name="photo"  placeholder="Enter lien photo">
											</div>

											<div class="form-group">
												<label for="nom">nom</label>
												
												<input type="text" class="form-control" name="nom" id="nom" placeholder="Enter nom" onclick="return verif()">
												<p id="errorC" class="error"></p>

											</div>
											<div class="form-group">
												<label for="lesson">lesson</label>
												<input type="text" class="form-control" name="lesson" id="lesson" placeholder="lesson">
											</div>
											<div class="form-group">
