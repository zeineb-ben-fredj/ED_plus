														...
														<div class="row">
															...
															<div class="col-md-6 pr-0">
																<div class="form-group form-group-default">
																	...
																	<input name="Date_conf" id="Date_conf" type="date" class="form-control" placeholder="fill position">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>Price</label>
																	<input name="montant_cmd" id="montant_cmd" type="number" class="form-control" placeholder="fill with the global price of the order">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>Payment method</label>
																	<input name="mode_paiement" id="mode_paiement" type="text" class="form-control" placeholder="fill with the payment method">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>State</label>
																	<input type="text" name="etat" id="etat" class="form-control" placeholder="fill with the state of the order">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>Purshase date</label>
																	<input type="date" name="Date_realisation" id="Date_realisation" class="form-control" placeholder="fill with the state of the order">
																</div>
															</div>
														</div>
													</form>
