...
try {
  ...
  $stmt = $conn->prepare("SELECT idcourse, subjects , numof_students, dateof_creation, descriptionsC, pictureC FROM tabcourse ORDER BY subjects");
  $stmt->execute();
