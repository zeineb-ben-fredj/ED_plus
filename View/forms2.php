					...
					<div class="row">
									...
									<div class="row">
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												...
												<label for="ref_cmd">Order reference</label>
												<input type="number" class="form-control" name="ref_cmd" id="email2" id="ref_cmd" value="<?php echo $orders['ref_cmd']; ?>">
									
											</div>
											<div class="form-group">
											<label for="Date_conf">date conf:  </label>
												<input type="date" class="form-control" id="Date_conf" name="Date_conf" value="<?php echo $orders['Date_conf']; ?>" onblur="saisirDate_conf()"> 
											...
											<label for="montant_cmd">montant:
												...
												<div class="col-md-9 p-0">
													<input onblur="saisirmnt()" type="number" class="form-control input-full" name="montant_cmd" id="montant_cmd" value="<?php echo $orders['montant_cmd']; ?>">
                        <p id="errorMC" class="error"></p>
											...
											<label for="mode_paiement">mode de paiement:
												...
												<input onblur="saisirpay()" type="text"  class="form-control" name="mode_paiement" id="mode_paiement" value="<?php echo $orders['mode_paiement']; ?>">
