...
<body data-background-color="dark">
	<div class="wrapper">
		...
		<div class="main-panel">
          ...
          <div>
           <br>
          <center> <a href="ajouters.php"> <button type="button" class="btn btn-primary btn-round ml-auto"><i class="fa fa-plus"></i>Add product</button></a></center>
           <br>
           <br>
...
<button type="submit" value="Supprimer" name="supprimer"  class="btn btn-outline-secondary" >Delete</button>

<input type="hidden" value="<?php echo $pro['id'] ?>" name="id">
</form></td>
<td> 
<form method="GET" action="Modifier.php">
<button type="submit" value="Modifier" name="Modifier"  class="btn btn-outline-info" >Edit</button>
...
<td> 
               <form method="POST" action="tri.php">
                     <input type="submit"  id="trier"  class="btn btn-primary btn-sm" value="Sort" ></input>
                     <input type="hidden" value=<?PHP echo  $pro['id']; ?> name="id">
               </form>
...
<ul class="pagination">
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="produit.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        <?php 
                        for($page = 1; $page <= $pages; $page++): ?>
                          <!-- Lien vers chacune des pages (activé si on se trouve sur la page correspondante) -->
                          <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="produit.php?page=<?= $page ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                          <!-- Lien vers la page suivante (désactivé si on se trouve sur la dernière page) -->
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="produit.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>     
