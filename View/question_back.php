...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
		...
		<div class="main-panel">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<p class="small">Add a new question using this form, make sure you fill them all</p>
													<form action=""  method="POST">
														<div class="row"> 
                                                       	
															<!-- <div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Id_Question</label>
																	<input  id="Id_Question" name="Id_Question" type="number" class="form-control" placeholder="fill ID">
															...
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	...
																	<input  id="Questions" name="Questions" type="string" class="form-control" >
                                                            ...
                                                            <div class="col-md-6">
																<div class="form-group form-group-default">
																	...
																	<input  id="Reponse_Correcte" name="Reponse_Correcte" type="string" class="form-control" >
                                                            ...
                                                            <div class="col-md-6">
																<div class="form-group form-group-default">
																	...
																	<input  id="Reponse_Fausse" name="Reponse_Fausse" type="string" class="form-control" >
															...
															<div class="col-md-6 pr-0">
																<div class="form-group form-group-default">
																<label>Quiz ID</label>
																	<select name="idtable" id="idtable" required>
			...
			<tr>
				...
				<td><?php echo $question['Reponse_Correcte']; ?></td>
				<td><?php echo $question['Reponse_Fausse']; ?></td>
				<td><?php echo $question['idtable']; ?></td>
				...
				<td>
					<form method="POST" action="modifierquestion.php">
						...
						<input type="hidden" value=<?PHP echo $question['Id_Question']; ?> name="Id_Question">
					</form>
				</td>
				<td>
					<a href="supprimerquestion.php?Id_Question=<?php echo $question['Id_Question']; ?>">Delete</a>
				</td>
			</tr>
			<?php
				}
