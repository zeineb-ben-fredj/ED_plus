...
if (
	...
	if(isset($_GET['sort'])){
		if($_GET['sort']=="ASC")
		{$listeshipping=$shippingC->affichershippingASC(); }
else if($_GET['sort']=="DESC")
{$listeshipping=$shippingC->affichershippingDESC(); }

}
if (isset($_GET['search'])){
	$filterval=$_GET['search'];
	$listeshipping=$shippingC->searchshipping($filterval);
...
<script type="text/javascript" src="verifiershipping1.js"></script>
</head>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item active submenu">
							...
							<div class="collapse show" id="tables">
								<ul class="nav nav-collapse">
									<li>
										<a href="tables/db_orders2.html">
											<span class="sub-item">Orders</span>
										</a>
									</li>
									<li class="active">
										<a href="demo2/tables/db_shipping2.html">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Shipping Data Base</h4>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<p class="small">Add a new Shipping to the data base</p>
													<form action="" method="POST">
														<div class="row">
															<div class="col-sm-12">
															<input  name="id_shipping" id="id_shipping" type="hidden" class="form-control" placeholder="fill with today's date" value="0">	
															<div class="form-group form-group-default">
																	<label>Order's reference</label>
																	<select  class="form-control" name="ref_cmd" id="ref_cmd">
																		<?php
																	foreach($listeorders as $orders){
																		?>
																	<option value="<?php echo $orders['ref_cmd'];?>">
																	Order's ID: <?php echo $orders['ref_cmd']; ?>
		</option>
		<?php
}
		?>
																	
																	<!-- <input name="ref_cmd" id="ref_cmd" type="number" class="form-control" placeholder="fill with order's reference" > -->
</select>
																</div>
															</div>
															<div class="col-md-6 pr-0">
																<div class="form-group form-group-default">
																	...
																	<input onblur="saisirDate_livr()" id="Date_livr" name="Date_livr" type="date" class="form-control" placeholder="fill with shipping date">
															...
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	...
																	<input onblur="saisirAdr_livr()" id="Adr_livr" name="Adr_livr" type="text" class="form-control" placeholder="fill shipping adress">
			...
			<tr>
				...
				<td>
					<form method="POST" action="modifiershippingform.php">
						<input type="submit" name="Modifier" class="btn btn-outline-info"  value="Edit">
						<input type="hidden" value=<?PHP echo $shipping['id_shipping']; ?> name="id_shipping">
					</form>
				</td>
				<td>
					<a class="btn btn-outline-secondary" href="supprimershipping.php?id_shipping=<?php echo $shipping['id_shipping']; ?>">Delete</a>
				</td>
			</tr>
			<?php
				}
