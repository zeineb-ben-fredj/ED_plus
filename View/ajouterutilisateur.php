<?php
    ...
    if (
        ...
        if (
            ...
            header('Location:../Model/site/site.php');
        }
        else
...
<p id="errorNBM" class="error"></p>
                        ...
                        <div class="input-group">
                            <input class="input--style-3 js-datepicker" type="date" placeholder="Daten" name="Daten" id="Daten"
                            required
                        ...
                        <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="Type1" id="Type1">
                                    <option disabled="disabled" selected="selected" required>Type</option>
...
<p id="errorTel" class="error"></p>
                    ...
                    <div class="input-group">
                        <input type="password"  class="input--style-3" name="Motpasse" id="Motpasse" placeholder=" Motpasse"
       ...
       <p id="errorP" class="error"></p>
                        ...
                        <div class="p-t-10">
                            ...
                            <button class="btn btn--pill btn--green" name="Enregistrer" type="submit" value="Envoyer">Enregistrer</button>
                        </div>
                        <div class="p-t-10">
                        <p class="loginhere">
                        </p>                        
