	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
			    		<div class="col-md-5 pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">AV Hedi Nouira Ennaser 2 Ariana Tunisia</span>
					    </div>
        ...
        <div class="card-header">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item"><a href="index_front.html" class="nav-link pl-0">Home</a></li>
	        	<li class="nav-item"><a href="about.html" class="nav-link">About</a></li>
	        	<li class="nav-item"><a href="teacher.html" class="nav-link">Student</a></li>
	        	<li class="nav-item active"><a href="courses.php" class="nav-link">Courses</a></li>
	        	<li class="nav-item"><a href="pricing.html" class="nav-link">Client</a></li>
            <li class="nav-item"><a href="pricing.html" class="nav-link">Shop</a></li>
	        	<li class="nav-item"><a href="blog.html" class="nav-link">Parent</a></li>
        ...
        <?php
        	...
        	<div class="col-md-6 col-lg-3 ftco-animate">
        		<div class="pricing-entry bg-light pb-4 text-center">
                 ...
                 <img src="assets/img/<?php echo $fichier['filepic']; ?>" height="360" width="270" alt="">
                ...
                <h6><?php echo $fichier['descriptionfichier']; ?></h6>
        			...
        			<p class="button text-center"><a href="assets/img/<?php echo $fichier['uploadfichier']; ?>" class="btn btn-tertiary px-4 py-3">Open Lesson</a></p>
        		</div>
